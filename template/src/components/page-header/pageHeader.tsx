...
import { ReactNode, useState, useEffect } from 'react'; //nexila changes
...
//nexila changes
const PageHeader = ({ title = "", badgeCount = null, showExport = false, moduleTitle = "", showModuleTile = true, children }: PageHeaderProps) => {
