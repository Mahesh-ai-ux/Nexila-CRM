...
import NexilaHackathonNormal from "../feature-module/Pages/public/nexilaHackathonNormal";
...
export const publicRoutes = [
  ...
  // =====================================
  // Nexila Hackathon - CRM
  // =====================================

  {
    id: "hackathon-list",
    path: route.hackathonList,
    element: <HackathonList />,
    route: Route,
    meta_title: "Hackathon Students",
  },

  {
    id: "hackathon-details",
    path: route.hackathonDetails,
    element: <HackathonDetails />,
    route: Route,
    meta_title: "Hackathon Student Details",
  },
...
export const authRoutes = [
  ...
  {
    id: "hackathon-public",
    path: route.hackathonPublic,
    element: <NexilaHackathon />,
    route: Route,
    meta_title: "Nexila Hackathon",
  },
  {
    id: "hackathon-public-normal",
    path: route.hackathonPublicNormal,
    element: <NexilaHackathonNormal />,
    route: Route,
    meta_title: "Nexila Hackathon Normal",
  },
  {
